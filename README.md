...
![Profile Views](https://komarev.com/ghpvc/?username=evillyna19&label=VISITAS&color=00e5ff&style=for-the-badge)
...
🌱 Atualmente estou construindo minha base na área de TI, aprendendo e desenvolvendo projetos para colocar meus conhecimentos em prática.

🚀 Este perfil é o espaço onde registro minha evolução, projetos e aprendizados ao longo dessa jornada.
...
| Projeto | Descrição |
| :---: | :--- |
| 💻 **Projeto 01** | Meu primeiro projeto em destaque |
| 🌐 **Projeto 02** | Projeto desenvolvido durante minha formação |
| ⚙️ **Projeto 03** | Projeto pessoal em desenvolvimento |
...
│ → Crescer profissionalmente em TI        │
└─────────────────────────────────────────┘
````
